    ...
    <div class="tw-max-w-6xl tw-mx-auto sm:tw-px-6 lg:tw-px-8">
      ...
      >
        <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2">
          ...
          <div
            class="
              tw-p-6 tw-border-t tw-border-gray-200
              dark:tw-border-gray-700
              md:tw-border-t-0 md:tw-border-l
            "
          >
            <div class="tw-flex tw-items-center">
              <svg
            ...
            <div class="tw-ml-12">
              ...
              >
                ...
                <a href="https://laravel.com/docs/billing" class="tw-underline"
                  >Cashier</a
                >,
                <a href="https://laravel.com/docs/dusk" class="tw-underline"
                  >Dusk</a
                >,
                <a
                  ...
                  >Echo</a
                >,
                <a href="https://laravel.com/docs/horizon" class="tw-underline"
                  >Horizon</a
                >,
      ...
      <div
        class="
          ...
          sm:tw-items-center sm:tw-justify-between
        "
      >
        ...
        <div
          class="
            tw-ml-4 tw-text-center tw-text-sm tw-text-gray-500
            sm:tw-text-right sm:tw-ml-0
          "
        >
